        ...
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
          ...
          <div className="relative z-20 mt-auto">
            {/* <blockquote className="space-y-2">
              <p className="text-lg">
                &ldquo;This platform has transformed how our team collaborates and delivers projects. The intuitive
                interface and powerful features have significantly improved our workflow.&rdquo;
              </p>
